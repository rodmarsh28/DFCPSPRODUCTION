    ...
    Sub SalesReportPU()
        ...
        Try
            ...
            With OleDBC
                ...
                '  "dbo.tblSales.SALESDATE AS SALESDATE, " & _
                '  "dbo.tblSales.SALESNO AS SLSNO, " & _
                '  "dbo.tblSales.CUSTOMERNAME AS CUSTOMERNAME, " & _
                ' "IsNULL(SUM ( dbo.tblPaid.AMOUNTPAID ),0) AS PAID , " & _
                ' "tblSales.TOTALAMOUNT - IsNULL(SUM ( dbo.tblPaid.AMOUNTPAID ),0) AS AMOUNT " & _
                ' "FROM  " & _
                ' "dbo.tblSales " & _
                ...
                ' "dbo.tblSales.CUSTOMERNAME, " & _
                ' "dbo.tblSales.PAYSTATUS "
                .CommandText = "SELECT dbo.tblSales.SALESDATE, " & _
                    "dbo.tblsalestr.SALESNO, " & _
                    "dbo.tblSales.CUSTOMERNAME, " & _
                    "CONVERT ( " & _
                     "VARCHAR ( 255 ), " & _
                    ...
                    "isnull(sum(dbo.tblPaid.AMOUNTPAID),0) as PAID, " & _
                    "dbo.tblsales.TOTALAMOUNT - isnull(sum(dbo.tblPaid.AMOUNTPAID),0) AS UNPAID " & _
                     "FROM dbo.tblSales " & _
                    "FULL OUTER join dbo.tblSalesTR ON dbo.tblSales.SALESNO = dbo.tblSalesTR.SALESNO " & _
                    "full outer JOIN dbo.tblPaid ON dbo.tblSales.SALESNO = dbo.tblPaid.SALESNO " & _
                      "where CONVERT(DATE,SALESDATE) between '" & Format(dfrom.Value, "MM/dd/yyyy") & "' and dateadd(day,1,'" & Format(dto.Value, "MM/dd/yyyy") & "') " & Customername & _
                       " GROUP by  " & _
                        "dbo.tblSales.SALESDATE, " & _
