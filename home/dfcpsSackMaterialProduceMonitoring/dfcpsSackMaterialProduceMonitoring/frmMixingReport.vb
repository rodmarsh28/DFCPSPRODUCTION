Public Class frmMixingReport
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        dgv.Item(17, R).Value = txtOtherBrand.Text
        dgv.Item(18, R).Value = txt11.Text
        dgv.Item(19, R).Value = txt12.Text
        dgv.Item(20, R).Value = Format(txtTime.Value, "MM/dd/yyyy hh:mm tt")
        ...
        Total = ppWt + caWt + modWt + col1Wt + col2Wt + othersWt
    ...
    Private Sub DeleteToolStripMenuItem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles DeleteToolStripMenuItem.Click
        For Each row As DataGridViewRow In dgv.SelectedRows
            ...
            othersWt = othersWt - dgv.CurrentRow.Cells(18).Value
            Total = ppWt + caWt + modWt + col1Wt + col2Wt + othersWt
            dgv.Rows.Remove(row)
            lblPPTot.Text = Format(ppWt, "N")
            lblCaTot.Text = Format(caWt, "N")
