Public Class frmCircularLoomsSec
    ...
    Sub delete()
        For Each row As DataGridViewRow In dgv.SelectedRows
            ...
            totProd = totProd - dgv.CurrentRow.Cells(9).Value
            totEff = totEff - dgv.CurrentRow.Cells(10).Value
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Else
            dgv.Item(6, c).Value = lblRollNo.Text
        End If
    ...
    Private Sub dgv_CellMouseDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.DataGridViewCellMouseEventArgs) Handles dgv.CellMouseDoubleClick
        ...
        txtProduction.Text = dgv.CurrentRow.Cells(9).Value
        txtEffiency.Text = dgv.CurrentRow.Cells(10).Value
        txtOperator.Text = dgv.CurrentRow.Cells(11).Value
        TXTWASTE.Text = dgv.CurrentRow.Cells(12).Value
        txtRemarks.Text = dgv.CurrentRow.Cells(13).Value
        delete()
        editmode = True
    End Sub
