Public Class frmHistoryList
    ...
    '        With OleDBC
    '            .Connection = conn
    '            .CommandText = "SELECT dbo.tblDoffed.rollNo,dbo.tblDoffed.doffDate,dbo.tblDoffed.loomNo,dbo.tblDoffed.mesh,dbo.tblDoffed.width," & _
    '                "dbo.tblDoffed.length,dbo.tblDoffed.weight,dbo.tblDoffed.doffer FROM dbo.tblDoffed " & _
    '                "ORDER BY dbo.tblDoffed.rollNo DESC"
    ...
    '            While OleDBDR.Read
    '                dgvDR.Rows.Add()
    '                dgvDR.Item(0, c).Value = OleDBDR.Item(0)
    '                dgvDR.Item(1, c).Value = Format(OleDBDR.Item(1), "MM/dd/yyyy")
    '                dgvDR.Item(2, c).Value = OleDBDR.Item(2)
    '                dgvDR.Item(3, c).Value = OleDBDR.Item(3)
    '                dgvDR.Item(4, c).Value = OleDBDR.Item(4)
    '                dgvDR.Item(5, c).Value = OleDBDR.Item(5)
    '                dgvDR.Item(6, c).Value = OleDBDR.Item(6)
    '                dgvDR.Item(7, c).Value = OleDBDR.Item(7)
    '                c = c + 1

    '            End While
    '        End If
    '        dgvDR.ClearSelection()
    '    Catch ex As Exception
    '        MsgBox(ex.Message)
    '    Finally
